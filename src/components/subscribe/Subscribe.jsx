...
const Subscribe = () => {
    ...
    return (
        <>
            <div className={style.templateSubscribe} data-aos="fade-up">
                ...
                <div className={style.rightSide}>
                    <div className={style.subscribeField}>
                        <Input value={Value} placeholder={"Email or Firstname Or Lastname"} onChange={(value) => setValue(value)} />
                        <div className={style.subscribeButton}>
                            <Button radius={"0"} label={'Subscribe'} />
                        </div>
                    </div>
                </div>
            </div>
