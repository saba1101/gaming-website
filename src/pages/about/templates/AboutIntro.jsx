...
const AboutIntro = () => {
    ...
    useEffect(() => {
        setSliderImages([SliderImage1, SliderImage2, SliderImage3, SliderImage4])
    }, [])
    return (
        <>
            <div className={style.templateAboutIntro}>
                ...
                >
                    ...
                    <p>
                        ...
                        dummy text ever since the 1500s. Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the
                ...
                <div
                    className={style.sliderPlaceholder}
                    data-aos="fade-left"
                >
                    <Slider
                        images={SliderImages}
